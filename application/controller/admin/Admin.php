			...
			foreach($section as $section_key=>$section_name) {
				...
				$section_data = array(
					...
					'form'=>array(
						...
						$section_key.'_devider'=>array(
							'label'=>$section_name,
							'type'=>'devider',
						),

						$section_key.'_render_method'=>array(
						...
						$section_key.'_hook_params'=>array(
						...
						$section_key.'_hook_priority'=>array(
						...
						$section_key.'_query_string'=>array(
						...
						$section_key.'_query_delay'=>array(
						...
						'submit_button'=>array(
							...
							'type'=>'button',
							'class'=>array('primary'),							
							'attr'=>array("data-action='save'",'data-tab_key="'.$key.'_'.$section_key.'"'),
							'inline'=>false
						),
					)
				);

				$tab[$key.'_'.$section_key] = $section_data;
			}			
		}
